...
//		}
		...
		public static Color GetNormalBackgroundColor( BindableObject? bindable )
			=> (Color)(bindable?.GetValue( NormalBackgroundColorProperty ) ?? bindable?.GetValue( VisualElement.BackgroundColorProperty )) ?? Colors.Black;
		...
		public static Color GetHoveredBackgroundColor(BindableObject? bindable)
			=> (Color)(bindable?.GetValue(HoveredBackgroundColorProperty) ?? bindable?.GetValue( VisualElement.BackgroundColorProperty )) ?? Colors.Black;
		...
		public static Color GetPressedBackgroundColor(BindableObject? bindable)
			=> (Color)(bindable?.GetValue(PressedBackgroundColorProperty) ?? bindable?.GetValue( VisualElement.BackgroundColorProperty )) ?? Colors.Black;
    ...
    public static void SetPressedBackgroundColor(BindableObject? bindable, Color value)
		...
		public static Color GetNativeAnimationColor( BindableObject? bindable )
			=> (Color)(bindable?.GetValue( NativeAnimationColorProperty ) ??  bindable?.GetValue( VisualElement.BackgroundColorProperty ));
